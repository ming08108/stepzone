...
const CARD = 'mb-5 border border-white/[0.09] p-5';
...
const TH =
  'border-b border-white/[0.09] px-2 py-1.5 text-left text-xs font-medium uppercase text-[#ececec]/55';
const TD = 'border-b border-white/[0.09] px-2 py-1.5 text-left tabular-nums';
const DT = 'text-xs text-[#ececec]/55';
      ...
      <div className="h-full overflow-y-auto px-[28px] py-8">
        <div className="mx-auto max-w-[1000px]">
          <section className={CARD}>
            <h2 className="mb-3 text-sm font-medium uppercase tracking-wider text-[#ececec]/55">
              Song
            </h2>
          ...
          {chart && (
            <section className={CARD}>
              <h2 className="mb-3 text-sm font-medium uppercase tracking-wider text-[#ececec]/55">
                Chart{' '}
                <span
                  className="ml-1 align-middle border px-2 py-0.5 text-[11px] font-semibold tracking-[0.1em]"
                  style={{ borderColor: AC + '80', color: AC }}
                >
                  {chart.stepsType}
                </span>
              </h2>
                ...
                <tbody>
                  {timingTable.map((r) => (
                    <tr key={r.beat}>
                      ...
                      <td className={`${TD} text-[#ececec]/55`}>
                        {r.beat === 2 ? '← 0.5s stop here' : ''}
                      </td>
                    </tr>
                  ))}
                </tbody>
